...
{
 public partial class IotResult
    {
        [JsonProperty("code")]
    ...
    public partial class Result
    {
        ...
        public DateOf DateOfBirth { get; set; }

        [JsonProperty("dateOfExpiry")]
        public DateOf DateOfExpiry { get; set; }
        ...
        [JsonProperty("immigrantCaseNumber")]
        public string ImmigrantCaseNumber { get; set; }

        [JsonProperty("issuer")]
        public string Issuer { get; set; }

        [JsonProperty("mrtdVerified")]
        public bool MrtdVerified { get; set; }
